# -*- coding: utf-8 -*-
# From: https://github.com/Barchid/RGBD-Seg/blob/master/dataloaders/cityscapes/pytorch_dataset.py
"""
...
class Cityscapes(CityscapesBase, DatasetBase):
    ...
    def get_image_path(self, idx):
        return os.path.join(self._data_dir, self.split, self.RGB_DIR, self._files['rgb'][idx]) 
    ...
    def get_depth_path(self, idx):
        return os.path.join(self._data_dir, self.split, self._depth_dir, self._files[self._depth_dir][idx]) 

from .imagenet import ImageNetBase, AdversarialImageNetBase
...
class ImageNet(ImageNetBase, DatasetBase):
    def __init__(self,
                 data_dir=None,
                 split='train'):
...
class AdversarialImageNet(AdversarialImageNetBase, DatasetBase):
    def __init__(self,
                 data_dir=None,
                 split='train'):
        super(AdversarialImageNet, self).__init__()
    ...
    def load_file_lists(self):
        ...
        label_file = _get_filepath(f'classification_label.txt')
        label_dir = self.list_from_file(label_file)
